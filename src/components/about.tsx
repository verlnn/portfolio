            ...
            <ScrollArea className="h-[360px] px-8 pb-8 md:h-[420px] md:px-10 md:pb-10">
              <div className="space-y-6 text-base md:text-lg leading-relaxed">
                ...
                <p className="text-foreground/90">
                  4년차 Java 백엔드 개발자로 대규모 의료 데이터 환경에서 시스템 개발과 운영을 경험했습니다. 최소 수천만 건에서 최대 약 60억
                  건 규모의 데이터를 처리하는 시스템을 다루며 장애 대응, 성능 개선, 시스템 안정화 경험을 쌓았습니다. Sybase, Vertica,
                  PostgreSQL, Oracle, MS SQL Server 등 다양한 DB 환경에서 데이터를 처리하는 서비스를 운영하며 실제 운영 환경에서 발생하는
                  문제를 구조적으로 분석하고 해결하는 역량을 갖추고 있습니다.
                </p>
                ...
                <p className="text-foreground/90">
                  ...
                  DB에 접속할 수 없게 되었고 프로젝트 개발이 중단될 위험이 있었습니다.
                </p>
                <p className="text-foreground/90">
                  ...
                  DB에 접근할 수 있도록 개발 환경을 복구했습니다.
                </p>
                <p className="text-foreground/90">
                  이 조치를 통해 개발 중단 상황을 해소하고 프로젝트 일정 지연 없이 개발을 지속할 수 있도록 환경을 복구했습니다. 이 경험을
                  통해 운영 환경과 네트워크 구조를 함께 고려한 문제 해결의 중요성을 체감했습니다.
                </p>
                ...
                <p className="text-foreground/90">
                  데이터 처리 로직에서 발생하던 성능 문제를 개선한 경험이 있습니다. 기존 코드에서는 이중 반복문과 find() 메서드가 결합된
                  구조로 인해 데이터 양이 많아질수록 브라우저 프리징이 발생했습니다.
                </p>
                <p className="text-foreground/90">
                  병목 원인을 분석한 뒤 검색 대상 데이터를 Set 자료구조로 변환하여 상수 시간 조회가 가능하도록 구조를 개선했습니다. 그 결과
                  데이터 처리 로직의 시간복잡도를 O(N×M)에서 O(N)으로 개선했고 브라우저 프리징 문제를 해결했습니다.
                </p>
                <p className="text-foreground/90">
                  이 경험을 통해 자료구조 선택이 실제 서비스 성능에 직접적인 영향을 미친다는 점을 실무에서 체감할 수 있었습니다.
                </p>
                ...
                <p className="text-foreground/90">
                  실무에서는 Sybase, Vertica, PostgreSQL, Oracle, MS SQL Server 등 다양한 DB 환경을 다루며 의료 데이터를 처리하는 시스템을
                  운영해 왔습니다. 데이터 규모는 검사 및 진단 데이터에 따라 차이가 있었지만 최소 수천만 건에서 최대 약 60억 건 수준까지
                  경험했으며, 서울대병원 환경 기준으로 월 약 400~500명의 사용자가 접속하는 서비스를 운영했습니다. 이러한 환경에서 데이터 조회,
                  연계, 처리 과정의 안정성과 성능을 고려한 시스템 운영 경험을 쌓았습니다.
                </p>
                ...
                <p className="text-foreground/90">
                  이를 통해 기능 변경 시 영향 범위를 명확히 파악할 수 있었고 기존 기능의 안정성을 유지하면서 새로운 기능을 확장할 수
                  있었습니다. 또한 코드와 문서에 변경 의도와 구조를 남겨 협업 과정에서도 이해하기 쉬운 코드를 유지하려 노력해 왔습니다.
                </p>
